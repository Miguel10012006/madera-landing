    ...
    <div className="flex bg-white text-gray-800 overflow-x-hidden">
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-black text-white z-40">
        <nav className="flex h-full items-center justify-around text-sm font-semibold">
          <a href="#inicio" className="text-white hover:text-green-400 transition">
            Inicio
          </a>
          <a
            href="#servicios"
      ...
      <main className="w-full md:ml-56">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl text-center text-white px-6">
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Carpintería en Madera <br className="hidden md:block" /> a Medida
            </h1>
            <p className="text-base sm:text-lg md:text-xl mb-8 text-gray-200">
              Closets, armarios, cocinas integrales y muebles personalizados con
            ...
            {[
              {
                ...
                desc: "Diseños funcionales que aprovechan cada espacio.",
              },
              {
                title: "Armarios",
                img: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c",
                desc: "Soluciones duraderas con acabados modernos.",
              },
              {
                title: "Muebles Personalizados",
                img: "https://images.unsplash.com/photo-1600121848594-d8644e57abab",
                desc: "Muebles únicos adaptados a tu estilo y necesidad.",
              },
            ].map((service) => (
              <div
                key={service.title}
        ...
        >
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              ¿Listo para tu proyecto en madera?
            </h2>
        ...
        <footer className="bg-black text-gray-400 text-center py-8 text-sm">
          <p>© 2025 Carpintería Artesanal en Madera</p>
          <p>Trabajos a medida • Atención personalizada</p>
        </footer>
